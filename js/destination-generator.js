...
// Render a fixed success card with clickable PR + deploy preview links
// after a successful publish. Auto-dismisses after 60s, or via close button.
...
async function handleDeploy() {
  ...
  try {
    ...
    if (res.ok && result.success) {
      showToast(result.message || 'Destino enviado para revisión', false);
